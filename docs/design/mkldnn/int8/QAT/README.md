...
This document is based on [QAT INT8 MKL-DNN in Paddle](https://github.com/PaddlePaddle/PaddleSlim/tree/develop/demo/mkldnn_quant), that describes how to use [Paddle Slim](https://github.com/PaddlePaddle/PaddleSlim/tree/develop/docs) to convert a quantization-aware trained model (Quant model) into INT8 MKL-DNN quantized model and run it.
