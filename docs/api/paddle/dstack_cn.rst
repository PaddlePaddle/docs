...
.. py:function:: paddle.dstack(x, name=None, *, out=None)
...
也可以参考下方的图示来理解 ``dstack`` 是如何对张量进行变换的。图片展示了两个形状为 [3] 的一维张量以及两个形状为 [3, 2] 的二维张量，这些张量在深度方向上堆叠后的结果。其中，形状为 [3] 的一维张量在堆叠时会被扩展为形状为 [1, 3] 的二维张量。
