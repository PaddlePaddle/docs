.. _cn_api_paddle_device_xpu_max_memory_allocated:

max_memory_allocated
-------------------------------

.. py:function:: paddle.device.xpu.max_memory_allocated(device=None)
...
COPY-FROM: paddle.device.xpu.max_memory_allocated
