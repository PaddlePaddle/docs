...
.. csv-table::
    ...
    " :ref:`paddle.cauchy_ <cn_api_paddle_cauchy_>` ", "Inplace 版本的 ceil API，对输入 x 采用 Inplace 策略"
    " :ref:`paddle.ceil_ <cn_api_paddle_ceil_>` ", "Inplace 版本的 cauchy API，对输入 x 采用 Inplace 策略"
