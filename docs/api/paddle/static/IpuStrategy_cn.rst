...
方法
::::::::::::
set_graph_config(self, num_ipus, is_training, batch_size, enable_manual_shard)
'''''''''
...
set_pipelining_config(self, enable_pipelining, batches_per_step, accumulation_factor)
'''''''''
