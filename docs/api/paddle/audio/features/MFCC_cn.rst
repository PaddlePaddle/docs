...
.. py:class:: paddle.audio.features.MFCC(sr=22050, n_mfcc=40, n_fft=512, hop_length=None, win_length=None, window='hann', power=2.0, center=True, pad_mode='reflect', n_mels=64, f_min=50.0, f_max=None, htk=False, norm='slaney', ref_value=1.0, amin=1e-10, top_db=None, dtype='float32')
...
::::::::::::
    ...
    - **norm** (Union[str, float]，可选) - 计算 fbank 矩阵时正则化的种类，默认是'slaney'，也可以 norm=1.0/2.0，使用 p-norm 正则化。
