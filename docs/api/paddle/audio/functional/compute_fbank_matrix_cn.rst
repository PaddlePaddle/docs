...
.. py:function:: paddle.audio.functional.compute_fbank_matrix(sr, n_fft, n_mels=64, f_min=0.0, f_max=None, htk=False, norm='slaney', dtype='float32')
...
::::::::::::
    ...
    - **n_mels** (int，可选) - mels bins 的数目，默认是 64。
