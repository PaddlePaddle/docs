...
.. csv-table::
    ...
    " :ref:`paddle.nn.init.sparse_ <cn_api_paddle_nn_init_sparse_>` ", "将二维 Tensor 原地初始化为稀疏矩阵"
...
.. csv-table::
    ...
    " :ref:`paddle.nn.utils.rnn.pad_sequence <cn_api_paddle_nn_utils_rnn_pad_sequence>` ", "填充并堆叠长度不同的 Tensor 序列"
