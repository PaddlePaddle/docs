...
.. csv-table::
    ...
    " :ref:`paddle.nn.PoissonNLLLoss <cn_api_nn_loss_PoissonNLLLoss>`", "PoissonNLLLoss 层"
...
.. csv-table::
    ...
    " :ref:`paddle.nn.functional.poisson_nll_loss <cn_paddle_nn_functional_loss_poisson_nll_loss>` ", "用于计算泊松分布的负对数似然损失"
