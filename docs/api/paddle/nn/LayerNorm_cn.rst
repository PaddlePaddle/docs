...
::::::::::::
    ...
    - **bias_attr** (ParamAttr|None，可选) - 指定偏置参数属性的对象。如果为 False 则偏差为 None。如果为 None ，则将添加默认 ParamAttr 作为偏置。如果添加了 ``bias_attr`` ，则将其初始化为 0。默认值：None。具体用法请参见 :ref:`cn_api_fluid_ParamAttr` 。
