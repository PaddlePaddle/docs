.. _cn_api_paddle_nn_CrossEntropyLoss:

CrossEntropyLoss
-------------------------------

.. py:class:: paddle.nn.CrossEntropyLoss(weight=None, ignore_index=-100, reduction='mean', soft_label=False, axis=-1, use_softmax=True, label_smoothing=0.0, name=None)
