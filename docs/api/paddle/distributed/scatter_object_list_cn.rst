...
.. py:function:: paddle.distributed.scatter_object_list(out_object_list, in_object_list=None, src=0, group=None)
...
:::::::::
    ...
    - **src** (int，可选) - 源进程的 rank，该进程的 object 列表将被分发到其他进程中。默认为 0，即分发 rank=0 的进程上的 object 列表。
