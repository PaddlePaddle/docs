.. _cn_api_paddle_compat_nn_BatchNorm3d:

BatchNorm3d
-------------------------------

.. py:class:: paddle.compat.nn.BatchNorm3d(num_features, eps=1e-5, momentum=0.1, affine=True, track_running_stats=True, device=None, dtype=None)

PyTorch 兼容的三维批归一化层，参数含义与 :ref:`cn_api_paddle_compat_nn_BatchNorm1d` 相同。
