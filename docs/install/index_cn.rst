...
* 需要安装 `CUDA <https://docs.nvidia.com/cuda/cuda-installation-guide-windows/>`_ ，根据您系统不同，对 CUDA 版本要求不同：
    ...
    * Windows 安装 GPU 版本
        ...
        * Windows 7/8/10 支持 CUDA 10.1/10.2/11.0/11.1/11.2/11.6 单卡模式 
        * 不支持 **nvidia-docker** 方式安装
    * Ubuntu 安装 GPU 版本

        * Ubuntu 16.04/18.04/20.04 支持 CUDA 10.1/10.2/11.0/11.1/11.2/11.6
        * 如果您是使用 **nvidia-docker** 安装，支持 CUDA 10.2/11.2
    * CentOS 安装 GPU 版本

        * 如果您是使用本机 **pip** 安装：

            * CentOS 7 支持 CUDA 10.1/10.2/11.0/11.1/11.2/11.6
        * 如果您是使用本机源码编译安装：
