...
* 需要安装 `CUDA <https://docs.nvidia.com/cuda/cuda-installation-guide-windows/>`_ ，根据您系统不同，对 CUDA 版本要求不同：
    ...
    * Ubuntu 安装 GPU 版本
        ...
        * Ubuntu 16.04/18.04/20.04/22.04 支持 CUDA 10.2/11.2/11.6/11.7/11.8
        * 如果您是使用 **nvidia-docker** 安装，支持 CUDA 10.2/11.2/11.7/11.8
    * CentOS 安装 GPU 版本

        * 如果您是使用本机 **pip** 安装：

            * CentOS 7 支持 CUDA 10.2/11.2/11.6/11.7/11.8
        * 如果您是使用本机源码编译安装：

            * CentOS 7 支持 CUDA 10.2/11.2/11.6/11.7/11.8
            * CentOS 6 不推荐，不提供编译出现问题时的官方支持
        * 如果您是使用 **nvidia-docker** 安装，在 CentOS 7 下支持 CUDA 10.2/11.2/11.7/11.8
...
7. 如果您希望使用 `pip <https://pypi.org/project/pip/>`_ 进行安装 PaddlePaddle 可以直接使用以下命令:
    ...
    (1). **CPU 版本** ：如果您只是想安装 CPU 版本请参考如下命令安装
        ...
        ::
            ...
            python -m pip install paddlepaddle==2.5.0rc0 -i https://mirror.baidu.com/pypi/simple
