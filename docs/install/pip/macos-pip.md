...
* 使用 macOS 中自带 Python 可能会导致安装失败。请使用[python 官网](https://www.python.org/downloads/mac-osx/)提供的 python3.9.x、python3.10.x、python3.11.x、python3.12.x、 python3.13.x。
