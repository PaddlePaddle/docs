...
1. 拉取PaddlePaddle镜像
    ...
    * GPU版的PaddlePaddle：
    ...
    在`:`后请您填写PaddlePaddle版本号，例如当前版本`2.1.3`，更多请见[镜像简介](#dockers)。
