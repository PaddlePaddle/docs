...
* CPU version of PaddlePaddle：
    ```
    docker pull registry.baidubce.com/paddlepaddle/paddle:2.3.1
    ```

* CPU version of PaddlePaddle, and the image is pre-installed with jupyter：
    ```
    docker pull registry.baidubce.com/paddlepaddle/paddle:2.3.1-jupyter
    ```

* GPU version of PaddlePaddle：
    ```
    nvidia-docker pull registry.baidubce.com/paddlepaddle/paddle:2.3.1-gpu-cuda10.2-cudnn7
    ```
    ```
...
* CPU version of PaddlePaddle：
    ```
    docker pull paddlepaddle/paddle:2.3.1
    ```

* CPU version of PaddlePaddle, and the image is pre-installed with jupyter：
    ```
    docker pull paddlepaddle/paddle:2.3.1-jupyter
    ```

* GPU version of PaddlePaddle：
    ```
    nvidia-docker pull paddlepaddle/paddle:2.3.1-gpu-cuda10.2-cudnn7
    ```
    ```
    nvidia-docker pull paddlepaddle/paddle:2.3.1-gpu-cuda11.2-cudnn8
    ```
...
* Use CPU version of PaddlePaddle：
    ...
    ```
    docker run --name paddle_docker -it -v $PWD:/paddle registry.baidubce.com/paddlepaddle/paddle:2.3.1 /bin/bash
    ```
    ...
    - `registry.baidubce.com/paddlepaddle/paddle:2.3.1`: Specify the name of the image to be used. You can view it through the 'docker images' command. /bin/Bash is the command to be executed in Docker
...
* Use GPU version of PaddlePaddle：
    ...
    ```
    nvidia-docker run --name paddle_docker -it -v $PWD:/paddle registry.baidubce.com/paddlepaddle/paddle:2.3.1-gpu-cuda10.2-cudnn7 /bin/bash
    ```
    ...
    - `registry.baidubce.com/paddlepaddle/paddle:2.3.1-gpu-cuda10.2-cudnn7`: Specify the name of the image to be used. You can view it through the 'docker images' command. /bin/Bash is the command to be executed in Docker
...
* Use CPU version of PaddlePaddle with jupyter：
    ...
    ```
    ```
    docker run -p 80:80 --rm --env USER_PASSWD="password you set" -v $PWD:/home/paddle registry.baidubce.com/paddlepaddle/paddle:2.3.1-jupyter
    ```
    ...
    - `registry.baidubce.com/paddlepaddle/paddle:2.3.1-jupyter`: Specify the name of the image to be used, you can view it through the `docker images` command
...
<table>
    ...
    <tbody>
        <tr>
        <td> registry.baidubce.com/paddlepaddle/paddle:2.3.1 </td>
        <td> CPU image with 2.3.1 version of paddle installed </td>
    </tr>
    <tr>
        <td> registry.baidubce.com/paddlepaddle/paddle:2.3.1-jupyter </td>
        <td> CPU image of paddle version 2.3.1 is installed, and jupyter is pre-installed in the image. Start the docker to run the jupyter service </td>
    </tr>
    <tr>
        <td> registry.baidubce.com/paddlepaddle/paddle:2.3.1-gpu-cuda11.2-cudnn8 </td>
        <td> GPU image of paddle version 2.3.1 is installed, cuda version is 11.2, cudnn version is 8.1 </td>
    </tr>
        <tr>
        <td> registry.baidubce.com/paddlepaddle/paddle:2.3.1-gpu-cuda10.2-cudnn7 </td>
        <td> GPU image of paddle version 2.3.1 is installed, cuda version is 10.2, cudnn version is 7 </td>
    </tr>
   </tbody>
</table>
</p>
