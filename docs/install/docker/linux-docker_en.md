...
* GPU version of PaddlePaddle(**Latest version of gpu image is recommended， and make sure NVIDIA Container Toolkit is installed successfully**)：
    ```
    docker pull ccr-2vdh3abv-pub.cnc.bj.baidubce.com/paddlepaddle/paddle:3.0.0-gpu-cuda12.3-cudnn9.0-trt8.6
    ```
    ```
...
* GPU version of PaddlePaddle(**Latest version of gpu image is recommended， and make sure NVIDIA Container Toolkit is installed successfully**)：
    ```
    docker pull paddlepaddle/paddle:3.0.0-gpu-cuda12.3-cudnn9.0-trt8.6
    ```
    ```
...
* Use CPU version of PaddlePaddle：
    ...
    - `ccr-2vdh3abv-pub.cnc.bj.baidubce.com/paddlepaddle/paddle:3.0.0`: Specify the name of the image to be used. You can view it through the 'docker images' command. /bin/Bash is the command to be executed in Docker
...
* Use GPU version of PaddlePaddle：
    ...
    ```
    docker run --gpus all --name paddle_docker -v $PWD:/paddle --network=host -it ccr-2vdh3abv-pub.cnc.bj.baidubce.com/paddlepaddle/paddle:3.0.0-gpu-cuda12.3-cudnn9.0-trt8.6 /bin/bash
    ```
    ...
    - `ccr-2vdh3abv-pub.cnc.bj.baidubce.com/paddlepaddle/paddle:3.0.0-gpu-cuda12.3-cudnn9.0-trt8.6`: Specify the name of the image to be used. You can view it through the 'docker images' command. /bin/Bash is the command to be executed in Docker
...
* Use CPU version of PaddlePaddle with jupyter：
    ...
    - `ccr-2vdh3abv-pub.cnc.bj.baidubce.com/paddlepaddle/paddle:3.0.0-jupyter`: Specify the name of the image to be used, you can view it through the `docker images` command
...
<table>
    ...
    <tbody>
        ...
        <td> CPU image with 3.0.0 version of paddle installed </td>
    </tr>
    <tr>
    ...
    <tr>
        <td> ccr-2vdh3abv-pub.cnc.bj.baidubce.com/paddlepaddle/paddle:3.0.0-gpu-cuda12.3-cudnn9.0-trt8.6 </td>
        <td> GPU image of paddle version 3.0.0 is installed, cuda version is 12.3, cudnn version is 9.0, trt version is 8.6 </td>
    </tr>
    <tr>
        <td> ccr-2vdh3abv-pub.cnc.bj.baidubce.com/paddlepaddle/paddle:3.0.0-gpu-cuda11.8-cudnn8.6-trt8.5 </td>
        <td> GPU image of paddle version 3.0.0 is installed, cuda version is 11.8, cudnn version is 8.6, trt version is 8.5 </td>
    </tr>
   </tbody>
</table>
</p>
