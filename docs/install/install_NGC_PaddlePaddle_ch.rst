...
如果您有 Docker 19.03 或更高版本，启动容器的典型命令是：
    ...
    ::
        ...
        docker run --gpus all --shm-sz=1g --ulimit memlock=-1 -it --rm nvcr.io/nvidia/paddlepaddle:22.07-py3
...
如果您有 Docker 19.02 或更早版本，启动容器的典型命令是：
    ...
    ::
        ...
        nvidia-docker run --shm-sz=1g --ulimit memlock=-1 -it --rm nvcr.io/nvidia/paddlepaddle:22.07-py3
