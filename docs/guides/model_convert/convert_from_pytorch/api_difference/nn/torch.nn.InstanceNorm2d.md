...
| <font color='red'> affine </font>             | -  | 是否使用可学习的仿射参数，Paddle 无此参数             |
| <font color='red'> track_running_stats </font>           |  -            | 是否跟踪运行是的 mean 和 var， Paddle 无此参数。  |
| <font color='red'> dtype </font>           |  -            | 输出数据类型， Paddle 无此参数。  |
