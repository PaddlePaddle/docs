...
### [paddle.nn.FractionalMaxPool2D](https://www.paddlepaddle.org.cn/documentation/docs/zh/develop/api/paddle/nn/FractionalMaxPool2D_cn.html#paddle.nn.FractionalMaxPool2D)
```python
