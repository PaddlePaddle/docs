...
### [torch.signal.windows.general\_cosine](https://docs.pytorch.org/docs/stable/generated/torch.signal.windows.general_cosine.html#torch.signal.windows.general_cosine)
```python
