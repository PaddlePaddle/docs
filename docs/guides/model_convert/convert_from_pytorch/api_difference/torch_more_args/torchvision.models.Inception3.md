...
| ---------------- | ------------ | -------------------------------------------------------------------- |
| num_classes      | num_classes  | 表示分类的类别数。                                                   |
| aux_logits       | -            | 是否使用辅助分类器，Paddle 无此参数。                                |
| transform_input  | -            | 是否对输入进行预处理，Paddle 无此参数。                              |
| inception_blocks | -            | 用于构建网络的 Inception 模块，Paddle 无此参数。                     |
| init_weights     | -            | 是否对权重进行初始化，Paddle 无此参数。                              |
| dropout          | -            | Dropout 概率，Paddle 无此参数。                                      |
