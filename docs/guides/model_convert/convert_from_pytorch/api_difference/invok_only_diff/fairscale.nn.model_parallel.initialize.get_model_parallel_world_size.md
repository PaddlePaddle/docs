## [ 仅 API 调用方式不一致 ]fairscale.nn.model_parallel.initialize.get_model_parallel_world_size
...
```python
# PyTorch 写法
world_size = fairscale.nn.model_parallel.initialize.get_model_parallel_world_size()
