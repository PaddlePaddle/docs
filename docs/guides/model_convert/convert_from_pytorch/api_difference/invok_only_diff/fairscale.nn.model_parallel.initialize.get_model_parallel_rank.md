...
```python
# PyTorch 写法
rank = fairscale.nn.model_parallel.initialize.get_model_parallel_rank()

# Paddle 写法
rank = paddle.distributed.fleet.base.topology._HYBRID_PARALLEL_GROUP.get_model_parallel_rank()
```
