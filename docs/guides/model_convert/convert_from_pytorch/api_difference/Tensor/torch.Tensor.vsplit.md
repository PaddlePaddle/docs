## [ 参数不一致 ]torch.Tensor.split_size_or_sections
...
### [paddle.Tensor.vsplit](https://www.paddlepaddle.org.cn/documentation/docs/zh/develop/api/paddle/Tensor_cn.html#vsplit-num-or-sections-name-none)

```python
paddle.Tensor.vsplit(num_or_sections, name=None)
```
...
# Pytorch 写法
torch.tensor(a).vsplit(indices_or_sections)

# Paddle 写法
num_or_sections = [1, 3, 2]
paddle.to_tensor(a).vsplit(num_or_sections)
