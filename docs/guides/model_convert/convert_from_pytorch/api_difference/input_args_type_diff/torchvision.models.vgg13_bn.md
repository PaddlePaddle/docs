...
### [torchvision.models.vgg13\_bn](https://pytorch.org/vision/stable/models/generated/torchvision.models.vgg13_bn.html#torchvision.models.vgg13_bn)
```python
torchvision.models.vgg13_bn(pretrained: bool = False, progress: bool = True, *, weights: Optional[VGG13_BN_Weights] = None, **kwargs: Any)
```

### [paddle.vision.models.vgg13](https://www.paddlepaddle.org.cn/documentation/docs/zh/develop/api/paddle/vision/models/vgg13_cn.html#paddle.vision.models.vgg13)
```python
