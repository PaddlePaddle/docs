...
你可参考飞桨框架的 `Github <https://github.com/PaddlePaddle/Paddle>`_ 了解详情，也可阅读 `版本说明 <../release_note_cn.html>`_ 了解最新版本的特性。
...
- `Kernel Primitives API <./11_kernel_primitives_api/index_cn.html>`_ : 介绍Paddle为加快算子开发提供的block级别的CUDA函数。
