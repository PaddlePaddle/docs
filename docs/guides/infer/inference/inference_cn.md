...
- 点此 [下载安装 Linux 预测库](https://www.paddlepaddle.org.cn/inference/v2.3/user_guides/download_lib.html)
- 点此 [下载安装 Windows 预测库](https://www.paddlepaddle.org.cn/inference/v2.3/user_guides/download_lib.html#windows)
