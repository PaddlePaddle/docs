...
本次飞桨黑客马拉松由深度学习技术及应用国家工程研究中心主办，百度飞桨承办，活动包含两大赛道：开源贡献个人挑战赛、飞桨护航计划集训营，等你来挑战！
...
以开源贡献为核心，发布 **10+** 开源项目的 **100+** 贡献任务，开源项目包括：飞桨核心框架、飞桨科学计算、飞桨 CV 套件、飞桨大模型套件、推理部署套件、生态伙伴项目等。**开发者使用 GitHub ID 报名，独立完成具有明确验收目标的贡献任务，获得对应的任务奖励。**
...
黑客松组委会将于 **2024/5/22 - 2024/5/26 期间（暂定）** 组织营员集中答辩，考核集训项目完成度与研发质量，**只有通过考核的营员才能获得对应的活动奖金与证书。**
...
| **2024/01/22 - 2023/02/08**         |   公开接收简历，安排面试   |
| **2024/02/08 19:00 GMT+8**          | 营员招募截止，公布招募名单 |
| **2024/05/22 - 2024/05/26（暂定）**  |        营员集中答辩        |
| **待定**                            |    公布通过考核营员名单    |
| **待定**                            |  集训营结营，公布考核结果  |
...
（1）活动期间均可报名，请在 **[活动页面](#)（待定）**  完成报名信息提交；

（2）请在赛道对应的 issue 下**按格式**回复报名信息，完成任务认领。

**补充信息**：

（1）两大赛道开发任务不冲突，不限制报名次数，开发者可自由选择感兴趣的开发任务进行报名和参与；
...
为了帮助大家更快更好的完成任务内容开发，本次活动预计会有 10+ 系列直播同步推出，包括 xx（待定） 等相关项目技术讲解、开源社区贡献等内容，由各研发方向的资深工程师深入讲解，敬请期待。
