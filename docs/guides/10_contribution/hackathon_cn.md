...
第九期 PaddlePaddle Hackathon 飞桨黑客马拉松预计于 **2025 年 8 月 20 日**上线，本次活动是面向全球开发者的深度学习领域编程活动，鼓励开发者了解与参与飞桨深度学习开源项目的开发实践。
...
> [!NOTE]
> **PR 提交格式要求：在 PR 的标题中以 【Hackathon 9th No.xxx】 开头，注明任务编号**
...
> [!IMPORTANT]
> 护航计划集训营提前批已于 **2025/07/25** 正式开始，正式批将于于 **2025/08/20** 开放报名。
...
文心系列大模型已在 **6 月 30 日**开源。为进一步扩大文心生态影响力，降低开发者上手门槛，并沉淀优质案例与教程，现正式发起本次征集活动。
...
```
【报名】：1
【主题】：使用 Llama Factory 对 ERNIE4.5 进行 SFT
```
...
1. **教程撰写**
   - 选手需自拟主题，按要求完成 tutorial 撰写。
   - 以 Notebook / Markdown 形式展现。
   - 确保代码可运行，结果可复现。

2. **PR 提交**

   - 将最终成果提交 PR 至 **community** 仓库，经组委会审核并成功合入后，即可获得奖金。

   - 共设 **10 个奖金名额**，先到先得，不限制个人提交数量。

3. **推广传播（可选）**

   - 使用审核通过的 tutorial 作为素材进行传播，可发文、短视频等形式不限。

   - 渠道可自由选择，包括但不仅限于 Discord、Twitter、微信公众号、知乎、B 站、小红书，或飞桨开源社区博客、AI Studio 项目等。

   - 传播时间不少于半个月，并需提供后台数据（如浏览量、点赞、收藏、评论、粉丝数）

   - 最终将依据传播影响力，评选 **一/二/三 等奖**
