...
营员以远程的方式深度参与开源项目开发实践，成果以 PR（Pull Requests）的形式贡献到指定代码仓库。导师全程指导，监督营员按期完成研发目标，每2周更新一次项目报告，接收黑客松组委会监督。
...
（1）活动期间（2023年9月13日至2023年12月22日）均可报名，请在 **活动页面(coming soon)** 完成报名信息提交；
