...
+--------------------------------------+-------------------------------------------------------+
| ElementwiseUnary                     | Compute API，输入与输出 Shape 相同的一元计算 API,     |
|                                      | 根据 OpFunc 计算规则完成一元函数运算。                |
+--------------------------------------+-------------------------------------------------------+
| ElementwiseBinary                    | Compute API，输入与输出 Shape 相同的二元计算 API，    |
|                                      | 根据 OpFunc 计算规则完成二元函数运算。                |
+--------------------------------------+-------------------------------------------------------+
| ElementwiseTernary                   | Compute API，输入与输出 Shape 相同的三元计算 API，    |
|                                      | 根据 OpFunc 计算规则完成三元函数运算。                |
+--------------------------------------+-------------------------------------------------------+
| ElementwiseAny                       | Compute API，输入与输出 Shape 相同的多元计算 API，    |
|                                      | 根据 OpFunc 计算规则完成多元函数运算。                |
+--------------------------------------+-------------------------------------------------------+
| CycleBinary                          | Compute API，两输入 Shape 的不同二元计算 API，        |
