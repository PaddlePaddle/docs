...
stop_gradient 表示是否停止计算梯度，默认值为 True，表示停止计算梯度，梯度不再回传。可以直接设置 stop_gradient 的值。
...
<div align=center>
<img src=./images/Tensor_broadcast.png>
