...
![](https://rte.weiyun.baidu.com/wiki/attach/image/api/imageDownloadAddress?attachId=1c587653aaee4dddb21c0f13cbd3ea6d&docGuid=usBqLmAfWjVloW "图1-1 FP16、BF16和FP32的数据格式")

![](https://rte.weiyun.baidu.com/wiki/attach/image/api/imageDownloadAddress?attachId=4bcc1f4af9594ae7a37af207a8e3001e&docGuid=usBqLmAfWjVloW "图1-2 FP16和FP32范围的对比")
...
![](https://rte.weiyun.baidu.com/wiki/attach/image/api/imageDownloadAddress?attachId=72daed20ee0749b691a980a89a686ac8&docGuid=usBqLmAfWjVloW "图1-3 FP16数据上下溢出表示及数据疏密程度")
