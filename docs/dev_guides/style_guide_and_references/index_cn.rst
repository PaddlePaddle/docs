...
- `报错信息文案书写规范 <./error_message_writing_specification_cn.html>`_ : Paddle 代码开发时增加报错提示需要遵循的规范。
...
- `类型提示标注规范  <./type_annotations_specification_cn.html>`_ : Python API 类型提示信息标注规范。
