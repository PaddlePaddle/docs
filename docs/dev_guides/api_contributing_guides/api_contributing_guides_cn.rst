...
飞桨专家对你提交的API设计文档进行审核，同时此文档也将接受来自开发者社区的评估，大家可以在pr评论区进行广泛的交流，开发者根据飞桨专家和其他开发者的反馈意见进行讨论并做出修改，最终评审通过后会在社区中公示，并准备合入。
...
.. csv-table::
    ...
    - Python API开发指南（请期待）
    - `C++ API开发指南（请期待）<./new_cpp_op_cn.html>`_ ", "`Github飞桨训练框架仓库 <https://github.com/PaddlePaddle/Paddle>`_"
