...
由于[曙光智算](https://www.hpccube.com/sso/login)环境下网路受限，直接编译飞桨源码会遇到第三方依赖库下载失败从而导致编译失败的问题。因此在曙光智算环境下进行飞桨源码编译与单测需要以下几个步骤：
...
**第一步**：登录[曙光智算](https://www.hpccube.com/sso/login) 平台后进入菜单顶部的「文件 -> E-File」环境
...
**第一步**：登录[曙光智算](https://www.hpccube.com/sso/login) 平台后进入页面中部的「我的服务 -> 智能计算服务」
