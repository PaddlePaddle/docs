...
You only need to focus on CI projects related to your submitted branch.For example,there is no need to check whether release/1.1 pass through test or not if you submit code to develop branch.
