...
<table>
    ...
    <tbody>
    <tr>
        <td> paddlepaddle==[版本号] 例如 paddlepaddle==1.8.3 </td>
        <td> 只支持CPU对应版本的PaddlePaddle，具体版本请参见<a href=https://pypi.org/project/paddlepaddle/#history>Pypi</a> </td>
    </tr>
    <tr>
        <td> paddlepaddle-gpu==[版本号] 例如 paddlepaddle-gpu==1.8.3 </td>
        <td> 默认安装支持CUDA 10.0和cuDNN 7的对应[版本号]的PaddlePaddle安装包 </td>
    </tr>
    <tr>
        <td> paddlepaddle-gpu==[版本号].postXX 例如 paddlepaddle-gpu==1.8.3.post97 </td>
