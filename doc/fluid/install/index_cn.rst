...
1. **CPU 版本**
    ...
    ::
        ...
        > hub.baidubce.com/paddlepaddle/paddle:1.8.5 是需要使用的image名称；/bin/bash是在Docker中要执行的命令
...
2. **GPU 版本**
    ...
    ::
        ...
        > hub.baidubce.com/paddlepaddle/paddle:1.8.5-gpu-cuda10.0-cudnn7 是需要使用的image名称；/bin/bash是在Docker中要执行的命令  
...
3. 如果您的机器不在中国大陆地区，可以直接从DockerHub拉取镜像：
    ...
    ::
        ...
        > paddlepaddle/paddle:1.8.5 是需要使用的image名称；/bin/bash是在Docker中要执行的命令
