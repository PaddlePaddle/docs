...
1. **CPU version**
    ...
    ::
        ...
        > hub.baidubce.com/paddlepaddle/paddle:1.8.3 is the image name you need to use；/bin/bash is the command to be executed in Docker
...
3. If your machine is not in China's mainland                                                                                                              , you can pull the image directly from DockerHub:
    ...
    ::
        ...
        > paddlepaddle/paddle:1.8.3 is the image name you need to use；/bin/bash is the command to be executed in docker
