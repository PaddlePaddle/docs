...
-  `Caffe模型转换为Paddle
   Fluid配置和模型文件工具 <https://github.com/PaddlePaddle/models/tree/develop/PaddleCV/image_classification/caffe2fluid>`__
...
- `Deep Attention Matching Network <https://github.com/PaddlePaddle/models/blob/develop/PaddleNLP/unarchived/deep_attention_matching_net>`__ 
