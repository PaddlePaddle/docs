...
关于 Padldle 中 Program 的详细设计思想，可以参考阅读 :ref:`Fluid设计思想 <../../advanced_usage/design_idea/fluid_design_idea.html>` 。

更多 Paddle 中的控制流，可以参考阅读 :ref:`API文档 <../../api_cn/layers_cn/layers_cn.html#control-flow>` 。
