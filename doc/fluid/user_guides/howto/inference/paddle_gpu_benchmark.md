...
## 测试对象
**Paddle, Pytorch, Tensorflow**   

- 在测试中，Paddle使用子图优化的方式集成了TensorRT, 模型[地址](https://github.com/PaddlePaddle/models/tree/develop/fluid/PaddleCV/image_classification/models)。
...
|batch_size|Paddle(ms)|pytorch(ms)|TensorFlow(ms)|
|---|---|---|---|
