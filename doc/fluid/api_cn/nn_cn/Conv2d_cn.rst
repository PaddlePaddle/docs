...
形状:
    ...
    .. math::
        H_{out} = \frac{\left ( H_{in} -\left ( dilation[0]*\left ( kernel_size[0]-1 \right )+1 \right ) \right )}{stride[0]}+1

        W_{out} = \frac{\left ( W_{in} -\left ( dilation[1]*\left ( kernel_size[1]-1 \right )+1 \right ) \right )}{stride[1]}+1
