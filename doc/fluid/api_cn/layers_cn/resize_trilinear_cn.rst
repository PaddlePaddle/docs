...
..  code-block:: python
    ...
    shape_tensor = fluid.layers.data(name='shape_tensor', shape=[3], dtype=
    ...
    actual_shape_tensor = fluid.layers.data(name='actual_shape_tensor', shape=[
        3], dtype='int32', append_batch_size=False)
    out3 = fluid.layers.resize_trilinear(input, out_shape=[4, 4, 8],
