...
..  code-block:: python
    ...
    data = paddle.data(name='data', shape=[1, 4, 2, 2], dtype='float32')
    space_to_depthed = fluid.layers.space_to_depth(x=data, blocksize=2)
    ...
    out_main = exe.run(paddle.default_main_program(), feed={'data': data_np},
