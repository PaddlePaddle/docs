...
..  code-block:: python
    ...
    input = paddle.data(name='x', shape=[3, 6], dtype='float32')
    index = paddle.data(name='index', shape=[12, 1], dtype='int64', lod_level=1)
    updates = paddle.data(name='updates', shape=[12, 1], dtype='float32',
        lod_level=1)
