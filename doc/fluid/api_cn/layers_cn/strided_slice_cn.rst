...
.. code-block:: python
    ...
    input = fluid.layers.data(name='input', shape=[3, 4, 5, 6], dtype='float32',
    ...
    strides_1 = [1, 1, 1]
    strides_2 = [1, 1, 2]
    sliced_1 = paddle.strided_slice(input, axes=axes, starts=starts, ends=ends,
    # sliced_1 is input[:, 0:3:1, 0:2:1, 2:4:1].
    # example 2:
    # attr starts is a list which contain tensor Variable.
        strides=strides_1)
    minus_3 = paddle.full([1], 'int32', -3, device=None, stop_gradient=True)
    sliced_2 = paddle.strided_slice(input, axes=axes, starts=[minus_3, 0, 2],
    # sliced_2 is input[:, 0:3:1, 0:2:1, 2:4:2].
        ends=ends, strides=strides_2)
