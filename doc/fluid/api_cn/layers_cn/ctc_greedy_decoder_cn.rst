...
..  code-block:: python
    ...
    x = paddle.data(name='x', shape=[None, 8], dtype='float32', lod_level=1)
    cost = fluid.layers.ctc_greedy_decoder(input=x, blank=0)
    # for padding mode
    x_pad = paddle.data(name='x_pad', shape=[10, 4, 8], dtype='float32')
    x_pad_len = paddle.data(name='x_pad_len', shape=[10, 1], dtype='int64')
