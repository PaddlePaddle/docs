...
.. code-block:: python
    ...
    data = paddle.eye(3, dtype='int32', out=None, stop_gradient=True)
    # Construct a batch of 3 identity tensors, each 2 x 2.
    # data[i, :, :] is a 2 x 2 identity tensor, i = 0, 1, 2.
    data = paddle.eye(2, 3, dtype='int32', out=None, stop_gradient=True)
    # Construct a batch of 3 identity tensors, each 2 x 2.
    # data[i, :, :] is a 2 x 2 identity tensor, i = 0, 1, 2.
    data = paddle.eye(2, out=None, stop_gradient=True)
    # Construct a batch of 3 identity tensors, each 2 x 2.
    # data[i, :, :] is a 2 x 2 identity tensor, i = 0, 1, 2.
