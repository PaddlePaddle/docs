.. _cn_api_fluid_dygraph_SyncBatchNorm:

SyncBatchNorm
-------------------------------

.. py:class:: paddle.fluid.dygraph.SyncBatchNorm(num_features, epsilon=1e-5, momentum=0.9, track_running_stats=True, weight_attr=None, bias_attr=None, data_format='NCHW', name=None)
