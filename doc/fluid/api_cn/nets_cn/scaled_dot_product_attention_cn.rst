...
.. code-block:: python
    ...
    queries = paddle.data(name='queries', shape=[3, 5, 9], dtype='float32')
    keys = paddle.data(name='keys', shape=[3, 6, 9], dtype='float32')
    values = paddle.data(name='values', shape=[3, 6, 10], dtype='float32')
