...
此模块将从 https://dataset.bj.bcebos.com/cifar/cifar-10-python.tar.gz 和 https://dataset.bj.bcebos.com/cifar/cifar-100-python.tar.gz 下载数据集，并将训练集和测试集解析为paddle reader creator。
...
它返回一个reader creator, reader中的每个样本的图像像素范围是[0，1]，标签范围是[0，99]。
