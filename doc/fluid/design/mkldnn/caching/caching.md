...
Cache clearing mode is to use in single-threaded scenario where available memory resources are limited in particular when executed model accept inputs of various shapes (NLP models).
