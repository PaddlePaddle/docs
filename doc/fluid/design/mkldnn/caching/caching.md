...
MKL-DNN Device context provide a method for erasing cache entries eg. MKLDNNDeviceContext::ResetBlobMap(). Currently ResetBlobMap() is used in two situations:
