...
| 版本说明      |     预测库(1.8.4版本)  |预测库(2.0.0)   |预测库(develop版本   |     编译器     |    构建工具      |  cuDNN  |  CUDA  |
|:---------|:---------------|:---------------|:-----------|:--------|:-------|:-------|:-------|
...
|    cuda10.1_cudnn7_avx_mkl | - | - | [paddle_inference.zip](https://paddle-wheel.bj.bcebos.com/develop/win-infer/mkl/post101/paddle_inference.zip) | MSVC 2015 update 3 |  CMake v3.17.0  |  7.6.5  |   10.1    |
|    cuda10.2_cudnn7_avx_mkl | - | - | [paddle_inference.zip](https://paddle-wheel.bj.bcebos.com/develop/win-infer/mkl/post102/paddle_inference.zip) | MSVC 2015 update 3 |  CMake v3.17.0  |  7.6.5 |    10.2    |
|    cuda11.0_cudnn7_avx_mkl | - | - | [paddle_inference.zip](https://paddle-wheel.bj.bcebos.com/develop/win-infer/mkl/post110/paddle_inference.zip) | MSVC 2015 update 3 |  CMake v3.17.0  |  8.0.2  |   11.0    |
