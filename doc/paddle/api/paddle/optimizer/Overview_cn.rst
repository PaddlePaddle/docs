...
.. csv-table::
    ...
    " :ref:`cn_api_paddle_optimizer_lr_NoamDecay` ", "Norm学习率衰减"
    " :ref:`cn_api_paddle_optimizer_lr_PiecewiseDecay` ", "分段设置学习率"
    " :ref:`cn_api_paddle_optimizer_lr_scheduler_PolynomialDecay` ", "多项式学习率衰减"
    " :ref:`cn_api_paddle_optimizer_lr_ReduceOnPlateau` ", "loss 自适应学习率衰减"
    " :ref:`cn_api_paddle_optimizer_lr_StepDecay` ", "按指定间隔轮数学习率衰减"
